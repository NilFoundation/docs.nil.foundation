...
Application developers are those users of Proof Market who fulfill the role of [**proof requesters**](../glossary#proof-requester).
...
Instead, the app can request the necessary proof via the [**Proof Market API**](./application-developers/api-requests) and update player records as soon as the correct proof is provided by the designated proof producer.
...
<CardSection>
    <Card icon={<img src={NewCircuit}/>} id='app-tut-1' title='Writing a new circuit' description='Learn more about writing a new circuit' to='/application-developers/tutorials/writing-new-circuit'/>
    <Card icon={<img src={Verify}/>} id='app-tut-2' title='Verifying a proof' description='Use in-EVM proof verification' to='/application-developers/tutorials/verifying-a-proof'/>
    <Card icon={<img src={Register}/>} id='app-tut-3' title='Signing up' description='Register inside Proof Market' to='/application-developers/tutorials/signing-up'/>
    <Card icon={<img src={Statements}/>} id='app-tut-4' title='Managing statements' description='Learn how to create and manage statements' to='/application-developers/tutorials/managing-statements'/>
    <Card icon={<img src={Request}/>} id='app-tut-5' title='Managing requests' description='Start publishing new proof requests' to='/application-developers/tutorials/managing-requests'/>
    <Card icon={<img src={Payments}/>} id='app-tut-6' title='Managing payments' description='Discover how payments work in Proof Market' to='/application-developers/tutorials/managing-payments'/>
</CardSection>
