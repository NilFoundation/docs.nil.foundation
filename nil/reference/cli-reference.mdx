...
| Subcommand | Definition |
|:--:|:--|
| `chain-id` | Retreives the ID of the current chain. |
| `gas-price` | Retrieves the gas price in the specified shard.  |
| `shards` | Retrives a list of all execution shards.  |
