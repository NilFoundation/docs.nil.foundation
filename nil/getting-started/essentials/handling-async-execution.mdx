...
:::tip[Payable functions]

It is recommended to make both the 'caller' and 'receiver' functions `payable` so that contracts can deposit the remainder left after the messages purchase the gas for their execution.
