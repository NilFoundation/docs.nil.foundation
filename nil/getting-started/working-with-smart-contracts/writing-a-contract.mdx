...
contract Retailer {
    ...
    function orderProduct(address dst, string calldata productName) public payable {
        dst.asyncCall(
            msg.sender,
            msg.sender,
            100000,
...
```solidity showLineNumbers
function createProduct(string calldata name) public onlyInternal payable {
