...
To decode the value, use `viem`, `ethers` or any other suitable decoding solution that accepts a custom ABI. An example of decoding is given below in the client library flows.
