...
nil_cli wallet send-tokens RETAILER_ADDRESS
```
...
nil_cli wallet send-tokens MANUFACTURER_ADDRESS
```
...
const faucetHash = await faucet.withdrawToWithRetry(addrR, 5_000_000n);
...
const faucetHashM = await faucet.withdrawToWithRetry(addrM, 5_000_000n);
