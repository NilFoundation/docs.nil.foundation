...
[**Cross-shard communications**](../core-concepts/shards-parallel-execution#message-passing-checks) are a built-in feature of the =nil; protocol ensuring horizontal scalability with no fragmentation.
...
In plain terms, this request changes the value stored under the account's address in [**the mapping of accounts and shards**](../core-concepts/accounts) stored in the consensus shard. 
...
[**Learn more about async calls**](../core-concepts/shards-parallel-execution#async-execution).
