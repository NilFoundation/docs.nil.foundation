...
When two accounts (Account 1 and Account 2) are co-located, communications between them can occur synchronously similarly to Ethereum transactions. 
...
This mechanism creates overhead that contract co-location avoids entirely. To learn more about contract co-location and its benefits, [**click here**](./core-concepts/contract-co-location).
