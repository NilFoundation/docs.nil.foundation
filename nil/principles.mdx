...
To learn more about cross-shard communication, [**click here**](./core-concepts/shards-parallel-execution#message-passing-checks) or read [**our primer**](./getting-started/essentials/handling-async-execution.mdx) on async execution.
