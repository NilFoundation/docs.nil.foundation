...
State fragmentation means that parts of Ethereum's global state are effectively scattered across systems that are detached from Ethereum itself. This leads to the following outcomes:
