...
All work related to processing transactions, storing accounts, and managing the local state occurs at the execution shard level. Execution shards fulfill three other roles listed below.
