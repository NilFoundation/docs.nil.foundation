...
* The expected gain for participating in shards where competition is less intense could outweigh the expected gain for partnering with high-load shards
* Execution shards are merged if their builders are inactive and their block count is below half of the block capacity of these shards
