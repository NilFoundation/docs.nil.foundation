...
Rolling back all accounts might seem excessive. After all, it is redundant to reset all accounts to their previous states if only a few accounts were affected by the attack.
