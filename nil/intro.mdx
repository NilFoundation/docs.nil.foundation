...
<CardSection>
    <Card icon={<img src={SolLibrary}/>} id='sol-library' title='Solidity library' description='Learn more about function modifiers and pre-compiled contracts' to='./tools/sol-library/func-modifiers'/>
</CardSection>
...
<CardSection>
    <Card icon={<img src={Architecture}/>} id='architecture' title='Architecture' description='Learn more about what makes =nil; stand out' to='./guides/architecture/ethereum-nil-diffs'/>
</CardSection>
