...
<CardSection>
    <Card icon={<img src={CLI}/>} id='cli' title='=nil; CLI' description='Configure the =nil; CLI' to='./tools/sol-library/nil-cli/usage'/>
    <Card icon={<img src={Hardhat}/>} id='hardhat' title='Hardhat' description='Set up the =nil; Hardhat plugin' to='./tools/sol-library/nil-cli/usage'/>
...
<CardSection>
    ...
    <Card icon={<img src={JS}/>} id='client' title='Nil.js reference' description='Read about key classes and functions' to='./reference/client/index'/>
